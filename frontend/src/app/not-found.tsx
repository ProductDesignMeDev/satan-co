...
export default function NotFound() {
  return (
    <main className="flex lg:flex-row lg:justify-between lg:items-start lg:text-start flex-col items-center text-center lg:h-screen h-full lg:ml-24 lg:mr-24 lg:mt-1 mt-24 ml-10 mr-10">
