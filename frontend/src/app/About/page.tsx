  ...
  return (
      <div className="relative flex flex-col items-center justify-center space-y-12 mt-2 sm:mt-36 text-center py-12 px-4 sm:px-0">
        ...
        <div className="flex items-center justify-center">
          <h2 className="text-[24px] sm:text-[40px] font-freckle text-center text-outline  text-primary4">
            ¿Quién es Satan&Co?
          </h2>
        </div>
        <div className="w-full max-w-[328px] sm:max-w-[888px] border-2 border-borderpink bg-[#e05bff]/15 rounded-3xl flex items-center justify-center p-4 sm:p-0 relative">
          <div className="w-full max-w-[281px] sm:max-w-[812px] rounded-lg p-4 sm:p-8 flex items-center sm:ml-8">
            <div className="text-white font-poppins text-[14px] sm:text-[20px] leading-relaxed sm:leading-[1.4] tracking-wide">
