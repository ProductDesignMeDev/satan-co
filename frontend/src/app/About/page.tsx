          ...
          <div>
            <div>
                <Image
                  src={HumoQuienes1}
                  alt="Fuego izquierda"
                  className="lg:w-[272px] lg:h-[479px] w-[120px] h-[230px] absolute lg:mt-28 mt-9  left-0 -z-50"
                />
            </div>
            <div>
                <Image
                  src={HumoQuienes2}
                  alt="Fuego derecha"
                  className="lg:w-[257px] lg:h-[479px] w-[120px] h-[230px] absolute lg:mt-28 mt-9 right-0 -z-50"
                />
            </div>
          </div>
        </div>
